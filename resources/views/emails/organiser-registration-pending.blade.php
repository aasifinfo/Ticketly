...
<head>
  ...
  <title>Organiser Registration Pending</title>
  <style>
  ...
  <div class="wrapper">
    <div class="card">
      ...
      <div class="body">
        ...
        <p>Your organiser account has been created successfully and is currently <strong>pending admin approval</strong>.</p>
        <p>We typically review applications within 24 hours. You will be notified once your account is approved.</p>
        <div class="note">
